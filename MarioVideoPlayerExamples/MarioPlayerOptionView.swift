...
public class PlayerOption{
    ...
    var icon: UIImage
    var title: String
    public init (id: String, icon: UIImage, title: String){
        self.id = id
        self.icon = icon
        self.title = title
    }
}
class MarioPlayerOptionView: UIViewController{
...
extension MarioPlayerOptionView: UITableViewDataSource{
...
extension MarioPlayerOptionView: UITableViewDelegate{
