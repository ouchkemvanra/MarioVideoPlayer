...
public enum MarioPlayerBufferstate: Int {
    case none           // default
    case readyToPlay
    case buffering
    case stop
...
public final class MarioVideoPlayerView: UIView{
    ...
    ///Slider
    var slider: MarioProgressBar!
    var sliderThumbnail: MarioSliderThumbnail!
    ///View
    var bgView: UIView!
    var seekingThumbnail: UIView!
    var playerView: UIView!
    var seekingForwardView: MarioSeekingView!
    var seekingBackwardView: MarioSeekingView!
    ...
    //MARK: ------ Player ------
    fileprivate var resourceLoaderManager = MarioPlayerResourceLoaderManager()
    var player: AVPlayer!
...
extension MarioVideoPlayerView{
    ...
    private func playViewBufferStateChanged(_ state: MarioPlayerBufferstate){
        if state == .buffering{
            showloading()
        } else{
            hideloading()
...
extension MarioVideoPlayerView: PanGestureDelegate{
