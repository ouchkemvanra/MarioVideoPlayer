//
//  MarioPlayerCacheMediaConfiguration.swift
//  MarioVideoPlayer
//
...
import Foundation
open class MarioPlayerCacheMediaConfiguration: NSObject, NSCoding, NSCopying{
    ...
    public required convenience init?(coder aDecoder: NSCoder) {
        guard let fileName = aDecoder.decodeObject(forKey: "fileName") as? String,
            ...
            let cacheMedia = aDecoder.decodeObject(forKey:"cacheMedia") as? MarioPlayerCacheMedia,
    ...
    public func copy(with zone: NSZone? = nil) -> Any {
        let confi = MarioPlayerCacheMediaConfiguration()
...
// MARK: - Update
extension MarioPlayerCacheMediaConfiguration {
    open func save() {
